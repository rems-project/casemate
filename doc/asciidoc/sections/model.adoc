Casemate maintains a shadow state,
tracking a finite state machine for each pagetable location
which encodes the protocol that the location should be following.
