...
#define PTE_FIELD_S1_AP2_READ_ONLY (U64_C(1))
#define PTE_FIELD_S1_AP2_READ_WRITE (U64_C(0))
...
#define PTE_FIELD_AF_SET (U64_C(1))
#define PTE_FIELD_AF_NOTSET (U64_C(0))

#define PTE_FIELD_S1_XN_LO 54
#define PTE_FIELD_S1_XN_MASK BIT(54)
#define PTE_FIELD_S1_XN_NOT_EXEC_NEVER (U64_C(0))
#define PTE_FIELD_S1_XN_EXEC_NEVER (U64_C(1))
...
#define PTE_FIELD_S2_S2AP0_READABLE (U64_C(1))
#define PTE_FIELD_S2_S2AP0_NOT_READABLE (U64_C(0))

#define PTE_FIELD_S2_S2AP1_LO 7
#define PTE_FIELD_S2_S2AP1_MASK BIT(7)
#define PTE_FIELD_S2_S2AP1_WRITEABLE (U64_C(1))
#define PTE_FIELD_S2_S2AP1_NOT_WRITEABLE (U64_C(0))
...
#define SCTLR_M_MASK (U64_C(1) << SCTLR_M_BIT)

#define HCR_VM_BIT 0
#define HCR_VM_MASK (U64_C(1) << HCR_VM_BIT)
